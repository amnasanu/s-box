...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0004_product_today_offer'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Completed', 'Compleated'), ('Cancelled', 'Cancelled')], default='New', max_length=10)),
